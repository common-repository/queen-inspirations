...
$qip_songs = array_merge( array_values( $qip_freddie_mercury ), array_values( $qip_roger_taylor ), array_values( $qip_brian_may ), array_values( $qip_queen ) );
